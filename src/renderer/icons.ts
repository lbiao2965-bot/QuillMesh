/**
 * Shared inline SVG icon set (24x24 viewBox, stroke-based, Lucide-style).
 * All icons inherit `currentColor` so they adapt to the active theme.
 */
...
const ICON_PATHS = {
  ...
  quote: '<path d="M10 11H6a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v5c0 2.5-1.5 3.5-3 4"/><path d="M20 11h-4a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v5c0 2.5-1.5 3.5-3 4"/>',
  ...
  wrap: '<line x1="3" y1="6" x2="21" y2="6"/><path d="M3 12h15a3 3 0 1 1 0 6h-4"/><polyline points="16 16 14 18 16 20"/>',

  // Tables / structure
  rows: '<rect x="3" y="4" width="18" height="16" rx="2"/><line x1="3" y1="12" x2="21" y2="12"/>',
...
export function iconSvg(name: IconName, size = 16): string {
  return `<svg class="colamd-icon" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${ICON_PATHS[name]}</svg>`
}

/** Replace the content of a button with the named icon. */
export function setButtonIcon(button: HTMLElement, name: IconName, size = 16): void {
