...
export class SearchPanel {
  ...
  constructor() {
    ...
    this.prevButton = this.btn('\u2039', 'search-btn', () => this.prev())
    this.nextButton = this.btn('\u203A', 'search-btn', () => this.next())
    this.closeButton = this.btn('\u00D7', 'search-btn search-close', () => this.hide())

    this.container.append(this.input, this.countEl, this.prevButton, this.nextButton, this.closeButton)
    this.applyLanguage()
  ...
  private applyLanguage(): void {
    ...
    this.prevButton.title = t('previousMatch')
    this.prevButton.setAttribute('aria-label', t('previousMatch'))
    this.nextButton.title = t('nextMatch')
    this.nextButton.setAttribute('aria-label', t('nextMatch'))
