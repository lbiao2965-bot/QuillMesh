...
Download any `.css` file and place it in `~/.colamd/themes/`, or use **Theme > Import Theme** in QuillMesh. The legacy directory is retained so existing themes continue to work after upgrading.
...
QuillMesh custom themes are plain CSS files. You can style the editor by targeting CSS custom properties or writing direct selectors.
